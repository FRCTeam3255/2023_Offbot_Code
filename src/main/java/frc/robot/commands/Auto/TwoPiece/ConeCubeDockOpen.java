...
public class ConeCubeDockOpen extends SequentialCommandGroup {
  ...
  public ConeCubeDockOpen(Drivetrain subDrivetrain, Intake subIntake, Wrist subWrist, Elevator subElevator,
      LEDs subLEDs) {
    ...
    addCommands(
        ...
        RobotContainer.swerveAutoBuilder.fullAuto(subDrivetrain.coneCubeDockOpen)
            .withTimeout(subDrivetrain.coneCubeDockOpen.getTotalTimeSeconds()),
