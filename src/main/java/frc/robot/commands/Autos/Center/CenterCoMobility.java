...
public class CenterCoMobility extends SequentialCommandGroup {
  ...
  public CenterCoMobility(Drivetrain subDrivetrain, Intake subIntake, Wrist subWrist, Elevator subElevator,
      LEDs subLEDs) {
    ...
    addCommands(
        ...
        Commands.runOnce(() -> subDrivetrain.setNavXAngleAdjustment(
            subDrivetrain.just_taxi.getInitialHolonomicPose().getRotation().getDegrees())),
        ...
        RobotContainer.swerveAutoBuilder.fullAuto(subDrivetrain.just_taxi)
            .withTimeout(subDrivetrain.just_taxi.getTotalTimeSeconds()),
