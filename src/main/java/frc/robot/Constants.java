...
public final class Constants {
  ...
  public static final class constWrist {
    public static final double ABSOLUTE_ENCODER_OFFSET = 0.333729;
    // The value in which the Raw Absolute Encoder value rolls over from 0 to 1
    public static final double ABSOLUTE_ENCODER_ROLLOVER_OFFSET = 0.666271;
  ...
  public static final class constElevator {
    ...
    public static final double ABSOLUTE_ENCODER_OFFSET = 0.844406;
    public static final double ABSOLUTE_ENCODER_ROLLOVER_OFFSET = 0.155594;
    public static final boolean ABSOLUTE_ENCODER_INVERT = true;
